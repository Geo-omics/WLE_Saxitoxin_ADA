...
GLAMR_sample_table_Dec9_23 <- read_xlsx("data/Great_Lakes_Omics_Datasets_Dec9_23_notebook3bONLY.xlsx", sheet = "samples") #Import GLAMR metadata

GLAMR_sample_table_sample_id_Dec9_23 <- GLAMR_sample_table_Dec9_23 %>% rename("SampleID" = "sample_id")
...
#write_csv(file = "data/sxt_perCOV_perID_mm2.csv", x = GLAMR_sample_table_sxt_samps_left_PERCENT_COVER_ID)
